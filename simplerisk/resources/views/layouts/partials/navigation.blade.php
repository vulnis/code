<header>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        @if (Auth::check())
        <button id="sidebarCollapse" class="navbar-toggler d-block" type="button" data-toggle="collapse" data-target="#navbarTogglerDemo01"
        ...
        <div class="collapse navbar-collapse" id="navbarMenu">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a href="#" id="userDropdown" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
                        aria-expanded="false">
