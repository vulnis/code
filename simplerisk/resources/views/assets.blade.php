...
@section('content')
@include('layouts.partials.tabs', ['items' => trans_choice('messages.Asset',2), 'item' => trans_choice('messages.Asset',1)])
...
<table class="table table-borderless">
    ...
    <div class="row">
        @if(!$asset)
        <button type="submit" name="submit" class="btn btn-primary pull-right save-asset-form">@lang('messages.Submit')</button>
        @endif
    </div>
</form>
</div>
