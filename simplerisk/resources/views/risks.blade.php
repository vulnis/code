...
@section('content')
    @include('layouts.partials.tabs', ['items' => trans_choice('messages.Risk',2),
'item' => trans_choice('messages.Risk',1)])
        ...
        <table class="table table-borderless">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        @if($item->category) {{ $item->category()->first()->name }} @endif
                    </td>
                    <td>@if($item->source) {{ $item->source()->first()->name }} @endif
                    </td>
